...
export class DefaultConverter implements ITypeDBToGraphology {
    ...
    constructor(parameters: StudioConverterStyleParameters) {
        this.styleParameters = parameters;
    }
...
DefaultConverter.defaultStyleParameters = {
    vertex_colors: {
